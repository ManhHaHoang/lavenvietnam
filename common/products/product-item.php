<div class="product-item">
    <a href="/san-pham?p<?= mt_rand(1, 20) ?>" class="flashsale-image">
    ...
    <div class="product-info">
        ...
        <h4 class="product-title">
            <a class="product-title-link" href="/san-pham?p<?= mt_rand(1, 20) ?>">LLorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</a>
        </h4>
